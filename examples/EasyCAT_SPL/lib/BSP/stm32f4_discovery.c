...
/** @defgroup STM32F4_DISCOVERY_LOW_LEVEL
  ...
  */
  ...
  const Led_TypeDef outPins[OUTPUT_BITS_COUNT] = { LED4, LED3, LED5, LED6 };

#elif defined(F407Z_ECAT_DEVKIT_HW)

  const Led_TypeDef outPins[OUTPUT_BITS_COUNT] = { LED0, LED1, LED2, LED3, 
                                                   LED4, LED5, LED6, LED7 };
...
const uint32_t GPIO_CLK[LEDn] = { LED0_GPIO_CLK, LED1_GPIO_CLK, LED2_GPIO_CLK, 
                                  LED3_GPIO_CLK, LED4_GPIO_CLK, LED5_GPIO_CLK, 
