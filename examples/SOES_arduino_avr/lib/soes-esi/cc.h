...
#else // ARDUINO_ARCH_AVR
#define CC_ATOMIC_SET(var,val)   ATOMIC_BLOCK(ATOMIC_RESTORESTATE) { var = val; }
#define CC_ATOMIC_GET(var)       (var)
#define CC_ATOMIC_ADD(var,val)   ATOMIC_BLOCK(ATOMIC_RESTORESTATE) { var += val; }
#define CC_ATOMIC_SUB(var,val)   ATOMIC_BLOCK(ATOMIC_RESTORESTATE) { var -= val; }
#define CC_ATOMIC_AND(var,val)   ATOMIC_BLOCK(ATOMIC_RESTORESTATE) { var &= val; }
#define CC_ATOMIC_OR(var,val)    ATOMIC_BLOCK(ATOMIC_RESTORESTATE) { var |= val; }
#endif // ARDUINO_ARCH_AVR
